...
class GiftTelegramSubscription private constructor(
	...
	textEntities: Array<ru.ravel.rtelebots.model.MessageEntity>?
) : KBaseRequest<GiftTelegramSubscription, ru.ravel.rtelebots.response.BaseResponse>(ru.ravel.rtelebots.response.BaseResponse::class) {
