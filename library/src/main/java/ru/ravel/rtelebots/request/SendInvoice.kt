...
class SendInvoice private constructor(
	...
	@Deprecated(
		"Use constructor with chatId or channelUsername instead",
		ReplaceWith("SendInvoice(chatId, title, description, payload, currency, prices.toList())")
	)
	constructor(
		chatId: Any,
		title: String,
	...
	fun sendPhoneNumberToProvider(sendPhoneNumberToProvider: Boolean) =
		applySelf { this.sendPhoneNumberToProvider = sendPhoneNumberToProvider }
