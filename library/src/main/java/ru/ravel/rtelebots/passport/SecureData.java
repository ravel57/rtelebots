...
public class SecureData implements Serializable {
	...
	public boolean equals(Object o) {
		...
		if (!Objects.equals(internal_passport, that.internal_passport))
			return false;
		if (!Objects.equals(driver_license, that.driver_license))
			return false;
		if (!Objects.equals(identity_card, that.identity_card))
			return false;
		if (!Objects.equals(address, that.address)) return false;
		if (!Objects.equals(utility_bill, that.utility_bill)) return false;
		if (!Objects.equals(bank_statement, that.bank_statement))
			return false;
